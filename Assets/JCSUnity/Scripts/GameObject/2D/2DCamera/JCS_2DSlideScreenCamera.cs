...
namespace JCSUnity
{
        ...
        : MonoBehaviour
    {
        ...
        private void InitCamera()
        {
            ...
            {
                JCS_GameErrors.JcsErrors("JCS_2DSlideScreenCamera",   "There is not JCS_2DCamera attach to, spawn a default one!");
            ...
            if (mJCS_2DCamera == null)
            {
                JCS_GameErrors.JcsErrors("JCS_2DMultiTrackCamera",   "The object spawn does not have the \"JCS_2DCamera\" components...");
                return;
            }
