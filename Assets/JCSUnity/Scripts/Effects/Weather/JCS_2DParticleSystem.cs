        ...
        : MonoBehaviour
    {
        ...
        private void SpawnParticles()
        {
            ...
            for (int index = 0;
                ...
                ++index)
            {
                JCS_WeatherParticle trans = (JCS_WeatherParticle)JCS_Utility.SpawnGameObject(mParticle);
        ...
        private JCS_WeatherParticle SearchAvaliableParticles()
        {
            if (mNumOfParticle == 0)
            {
                JCS_GameErrors.JcsErrors("JCS_2DParticleSystem",   "No Particle assign...");
                return null;
            }
