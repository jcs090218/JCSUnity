/**
 * $File: JCS_2DReflecBulletAction.cs $
 * $Date: $
 * $Revision: $
...
namespace JCSUnity
{
    ...
    public class JCS_2DReflecBulletAction
        : MonoBehaviour
    {
...
degree lower than 90.")]
        ...
        private void ReflectBullet(JCS_Bullet bullet)
        {
            ...
            float randDegree = JCS_Utility.JCS_FloatRange(-mRandomReflectDegree, mRandomReflectDegree);
