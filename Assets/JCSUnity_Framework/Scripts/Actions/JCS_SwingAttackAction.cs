...
namespace JCSUnity
{
        ...
        , JCS_Action
    {
        ...
        [SerializeField]
        private JCS_ApplyDamageTextAction mApplyDamageTextAction = null;
        ...
        [SerializeField] private float mTimeToActTime = 0;
        private bool mAfterDelay = false;

        [Tooltip("Time after attack, delay a while.")]
        [SerializeField] private float mActTime = 0;
        ...
        private void Awake()
        {
            ...
            if (mApplyDamageTextAction == null)
                this.mApplyDamageTextAction = this.GetComponentInChildren<JCS_ApplyDamageTextAction>();
