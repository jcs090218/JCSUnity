...
namespace JCSUnity
{
        ...
        : MonoBehaviour
    {
        ...
        protected void SpawnMainAnim1()
        {
            if (mMainAnim1 == null)
            {
                JCS_GameErrors.JcsReminders("JCS_2DActiveSkillAction", -1, "Assigning active skill action without animation is not allowed.");
                return;
            }

            GameObject obj = JCS_UsefualFunctions.SpawnAnimateObject(mMainAnim1, mOrderLayer);
        ...
        protected void SpawnMainAnim2()
        {
            ...
            GameObject obj = JCS_UsefualFunctions.SpawnAnimateObject(mMainAnim2, mOrderLayer + 1);
