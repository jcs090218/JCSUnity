...
namespace JCSUnity
{
        ...
        : MonoBehaviour
    {
        ...
        public void SpawnDamagetTexts(int[] damage, Vector2[] pos)
        {
            ...
            {
                JCS_GameErrors.JcsErrors("JCS_DamageTextPool", -1, "Wrong pair size!");
                return;
            }
        ...
        public void SpawnDamageTextFromPool(int damage, Vector2 pos)
        {
            ...
            SpawnDamageTextFromPool(damage, pos);
        }
        ...
        private void InitDamageTextToArray()
        {
                ...
                ++count)
            {
                ...
                JCS_DamageText dt = (JCS_DamageText)JCS_UsefualFunctions.SpawnGameObject(mDamagetText);
