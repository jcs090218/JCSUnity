...
namespace JCSUnity
{
    public class JCS_FadeSound : MonoBehaviour
    {
        ...
        public void SetAudioSource(AudioSource source)
        {
            if (source == null)
            {
                JCS_GameErrors.JcsErrors("JCS_FadeSound", -1, "source assign are null references...");
                return;
            }
        ...
        public void FadeOut(float target_volume, float time)
        {
            ...
            {
                JCS_GameErrors.JcsErrors("JCS_FadeSound", -1, "Already Fade out");
                return;
            }

            if (mAudioSource == null)
            {
                JCS_GameErrors.JcsErrors("JCS_FadeSound", -1, "Cannot do the fade out effect without the source...");
                return;
            }
        ...
        public void FadeIn(float target_volume, float time)
        {
            ...
            {
                JCS_GameErrors.JcsErrors("JCS_FadeSound", -1, "Already Fade in");
                return;
            }

            if (mAudioSource == null)
            {
                JCS_GameErrors.JcsErrors("JCS_FadeSound", -1, "Cannot do the fade in effect without the source...");
                return;
            }
