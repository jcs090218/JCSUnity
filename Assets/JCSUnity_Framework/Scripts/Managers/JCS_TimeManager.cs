...
namespace JCSUnity
{
        ...
        : MonoBehaviour
    {
        ...
        //----------------------
        // Private Variables
        [SerializeField] private JCS_TimeRange mCurrentTimeRange = JCS_TimeRange.UNKNOWN;
        [SerializeField] private JCS_SeasonType mCurrentSeasonType = JCS_SeasonType.UNKNOWN;
        [SerializeField] private JCS_WeatherType mCurrentWeatherType = JCS_WeatherType.UNKNOWN;
